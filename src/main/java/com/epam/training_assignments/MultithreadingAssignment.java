package com.epam.training_assignments;

public class MultithreadingAssignment {
    public static MultithreadingAssignment output = new MultithreadingAssignment ();
    ...
    private final Object syncher = new Object ();  // we use an explicit synch Object, you could use annotation on methods, too. like ABHISHEK did.
...
class Runnable2 implements Runnable{
    public void run(){
        for(char i='A';i<='Z';i++) {
            MultithreadingAssignment.output.print(i);
        }
    }
}
