...
public class PreferredPassword extends Generator
{
    ...
    private int prefferedPasswordLength = 10;
    ...
    public void setPrefferdPassword()
    {
        ...
        while (true)
        {
            ...
            setPrefferedPasswordLength(val);
    ...
    public String toString()
    {
        return "PreferredPassword [IncludeUpper=" + includeUpperLetters + ", IncludeLower=" + includeLowerLetters + ", IncludeNum="
                + includeNumbers + ", IncludeSym=" + includeSymbols + ", length=" + prefferedPasswordLength + "]";
    }
    ...
    public int getPrefferedPasswordLength()
    {
        return prefferedPasswordLength;
    }


    public void setPrefferedPasswordLength(int prefferedPasswordLength)
    {
        this.prefferedPasswordLength = prefferedPasswordLength;
    }
